...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*");
		System.out.println("                                                        Bienvenido al banco 'Tu Ruina'                                                                            ");
		System.out.println("*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*");
		...
		do {
			...
			switch(op) {
				...
				case 2:
					...
					//en lugar del método comprobar puedes poner un while hasya que no meta una cantidad mayor que saldo no te deja salir.
