...
public class CuentaCorriente {
	...
	// nunca se ponen asignaciones en el return
	// si el no hace falta mostrar el saldo se puede hacer con void, en el caso de que devuelva el saldo, hay que meter el método en un syso
	...
	public void retirarDinero(double retirada,boolean comprobado) {
		if(comprobado==true) {
			saldo-=retirada;
		}
